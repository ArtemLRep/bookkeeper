...
class CatExpenseModel(QAbstractTableModel):
    ...
    def __init__(self, repo: list[list[Union[str, float]]]) -> None:
        super().__init__()
        self._data = repo
...
class MainWindow(QMainWindow):
    ...
    def set_line_category(self, category_data: list[Category]) -> None:
        """
